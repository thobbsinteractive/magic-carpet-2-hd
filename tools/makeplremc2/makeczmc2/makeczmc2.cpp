// makeczmc2.cpp : Tento soubor obsahuje funkci main. Prov√°dƒõn√≠ programu se tam zahajuje a ukonƒçuje.
//
...
char* removeDiakritics(char* text) {
	char* withdia =    (char*)"·¡Ë»ÔœÈ…ÏÃÌÕÚ“Û”¯ÿöäùç˙⁄˘Ÿ˝›ûéπ•Ê∆Í ≥£Ò—úåüèøØ";
...
int main(int argc, char *argv[])
{
	...
	sprintf_s(text3, "%s", "√°√Åƒçƒåƒèƒé√©√âƒõƒö√≠√ç≈à≈á√≥√ì≈ô≈ò≈°≈†≈•≈§√∫√ö≈Ø≈Æ√Ω√ù≈æ≈Ω");*/
