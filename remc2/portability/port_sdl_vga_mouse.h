...
void VGA_Blit(uint8_t* srcBuffer, uint8_t* alphaBuffer = nullptr);
void SubBlit(uint16_t originalResWidth, uint16_t originalResHeight, uint8_t* alphaBuffer = nullptr);
