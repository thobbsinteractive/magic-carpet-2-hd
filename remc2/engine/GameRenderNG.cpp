			...
			if (!D41A0_0.array_0x2BDE[D41A0_0.LevelIndex_0xc].MenuState_0x3DF_2BE4_12221)
			{
				if (x_D41A0_BYTEARRAY_4_struct.m_wHighSpeedSystem)
				{
					if (x_DWORD_E9C3C)
					{
						...
						{
							v34 = Entities_EA3E4[D41A0_0.array_0x2BDE[D41A0_0.LevelIndex_0xc].word_0x00a_2BE4_11240]->actSpeed_0x82_130;
...
void GameRenderNG::sub_88740(type_entity_0x6E8E* a1x, int16_t posX, int16_t posY)
{
	...
	if (str_unk_1804B0ar.PopupStatusByte_0x9e & 1)
		return;
	v4x = Entities_EA3E4[D41A0_0.array_0x2BDE[D41A0_0.LevelIndex_0xc].word_0x00a_2BE4_11240];
...
void GameRenderNG::DrawSorcererNameAndHealthBar_2CB30(type_entity_0x6E8E* a1x, __int16 a2, int a3, __int16 a4)//20db30 //maybe draw sorcerer name
{
	char* v5; // esi
	int v9x; // eax
	int v9y; // eax
