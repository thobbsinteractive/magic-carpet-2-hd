...
void GameRenderGL::SubDrawCaveTerrainAndParticles(std::vector<int>& projectedVertexBuffer, int pitch)
{
...
void GameRenderGL::SubDrawInverseTerrainAndParticles(std::vector<int>& projectedVertexBuffer, int pitch)
{
	int v25z;
...
void GameRenderGL::SubDrawTerrainAndParticles(std::vector<int>& projectedVertexBuffer, int pitch)
{
...
void GameRenderGL::DrawSquareInProjectionSpace(std::vector<int>& vertexs, int index)
{
	...
	{
		DrawTriangleInProjectionSpace_B6253(&vertex18, &vertex12, &vertex0);
		DrawTriangleInProjectionSpace_B6253(&vertex0, &vertex12, &vertex6);
	}
	else
	{
		DrawTriangleInProjectionSpace_B6253(&vertex18, &vertex12, &vertex6);
		DrawTriangleInProjectionSpace_B6253(&vertex18, &vertex6, &vertex0);
	}
}
...
void GameRenderGL::DrawInverseSquareInProjectionSpace(int* vertexs, int index)
{
...
void GameRenderGL::DrawInverseSquareInProjectionSpace(int* vertexs, int index, uint8_t* pTexture)
{
	//Set Texture coordinates for polys
	vertexs[20] = UVTable_D4350[m_ptrStr_E9C38_smalltit[index].textUV_42][0];
	vertexs[21] = UVTable_D4350[m_ptrStr_E9C38_smalltit[index].textUV_42][1];
	...
	{
		DrawTriangleInProjectionSpace_B6253(&vertex18, &vertex0, &vertex12);
		DrawTriangleInProjectionSpace_B6253(&vertex0, &vertex6, &vertex12);
	}
	else
	{
		DrawTriangleInProjectionSpace_B6253(&vertex18, &vertex6, &vertex12);
		DrawTriangleInProjectionSpace_B6253(&vertex18, &vertex0, &vertex6);
	}
}
...
void GameRenderGL::DrawTriangleInProjectionSpace_B6253(const ProjectionVertex* vertex1, const ProjectionVertex* vertex2, const ProjectionVertex* vertex3)
{
	...
	if (y1 <= y2)
	{
			...
			LABEL_24:
				...
				if (((v4->X - v3->X) << 16) / v13 > v1103)
				{
					...
					case 0xF:
						...
						LABEL_121:
							v62 = LoadPolygon((x_DWORD*)unk_DE56Cx[0], &v58, &v59, v1103, v1107, &v1117);
							v61 = v1121;
						LABEL_124:
							if (v1296)
							{
					...
					case 0x11:
						...
						v55 = LoadPolygon((x_DWORD*)unk_DE56Cx[0], &v50, &v51, &v52, v1103, v1107, v1148, &v1117);
						v54 = v1121;
						goto LABEL_102;
					case 2:
					case 3:
					...
					case 0x17:
						...
						v43 = LoadPolygon((x_DWORD*)unk_DE56Cx[0], &v37, &v38, &v39, &v40, v1103, v1107, v1126, v1137, &v1117);
						v42 = v1121;
						goto LABEL_77;
					case 5:
					case 6:
					...
					case 0x1A:
						...
						v28 = LoadPolygon((x_DWORD*)unk_DE56Cx[0], &v21, &v22, &v23, &v24, &v25, v1103, v1107, v1125, v1136, v1147, &v1117);
						v27 = v1121;
						goto LABEL_51;
					}
				}
		...
		LABEL_234:
			...
			case 0xF:
				...
				LoadPolygon((x_DWORD*)unk_DE56Cx[0], &v139, &v140, v1105, v1109, &v1115);
				v31 = (uint8_t)x_BYTE_E126D;
				goto LABEL_53;
			case 1:
			case 4:
			...
			case 0x11:
				...
				LoadPolygon((x_DWORD*)unk_DE56Cx[0], &v134, &v135, &v136, v1105, v1109, v1152, &v1115);
				v31 = (uint8_t)x_BYTE_E126D;
				goto LABEL_53;
			case 2:
			case 3:
			...
			case 0x17:
				...
				LoadPolygon((x_DWORD*)unk_DE56Cx[0], &v128, &v129, &v130, &v131, v1105, v1109, v1130, v1141, &v1115);
				v31 = (uint8_t)x_BYTE_E126D;
				goto LABEL_53;
			case 5:
			case 6:
			...
			case 0x1A:
				...
				LoadPolygon((x_DWORD*)unk_DE56Cx[0], &v120, &v121, &v122, &v123, &v124, v1105, v1109, v1129, v1140, v1151, &v1115);
				v31 = (uint8_t)x_BYTE_E126D;
				goto LABEL_53;
			}
		}
	...
	LABEL_277:
		...
		case 0xF:
			...
			LoadPolygon((x_DWORD*)unk_DE56Cx[0], &v165, &v166, v1106, v1110, &v1116);
			v31 = (uint8_t)x_BYTE_E126D;
			goto LABEL_53;
		case 1:
		case 4:
		...
		case 0x11:
			...
			LoadPolygon((x_DWORD*)unk_DE56Cx[0], &v160, &v161, &v162, v1106, v1110, v1154, &v1116);
			v31 = (uint8_t)x_BYTE_E126D;
			goto LABEL_53;
		case 2:
		case 3:
		...
		case 0x17:
			...
			LoadPolygon((x_DWORD*)unk_DE56Cx[0], &v154, &v155, &v156, &v157, v1106, v1110, v1132, v1143, &v1116);
			v31 = (uint8_t)x_BYTE_E126D;
			goto LABEL_53;
		case 5:
		case 6:
		...
		case 0x1A:
			...
			LoadPolygon((x_DWORD*)unk_DE56Cx[0], &v146, &v147, &v148, &v149, &v150, v1106, v1110, v1131, v1142, v1153, &v1116);
			v31 = (uint8_t)x_BYTE_E126D;
			goto LABEL_53;
		}
	}
...
LABEL_129:
	...
	if (((v4->X - v3->X) << 16) / v68 > v1104)
	{
		...
		case 0xF:
			...
			v114 = LoadPolygon((x_DWORD*)unk_DE56Cx[0], &v110, &v111, v1104, v1108, &v1114);
			v113 = v1122;
		LABEL_228:
			if (v1297)
			{
		...
		case 0x11:
			...
			v107 = LoadPolygon((x_DWORD*)unk_DE56Cx[0], &v102, &v103, &v104, v1104, v1108, v1150, &v1114);
			v106 = v1122;
			goto LABEL_206;
		case 2:
		case 3:
		...
		case 0x17:
			...
			v95 = LoadPolygon((x_DWORD*)unk_DE56Cx[0], &v89, &v90, &v91, &v92, v1104, v1108, v1128, v1139, &v1114);
			v94 = v1122;
			goto LABEL_181;
		case 5:
		case 6:
		...
		case 0x1A:
			...
			v81 = LoadPolygon((x_DWORD*)unk_DE56Cx[0], &v74, &v75, &v76, &v77, &v78, v1104, v1108, v1127, v1138, v1149, &v1114);
			v80 = v1122;
			goto LABEL_156;
		}
	}
