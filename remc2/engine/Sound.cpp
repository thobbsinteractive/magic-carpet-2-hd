...
void sub_8F100_sound_proc19(uint32_t flags, __int16 index, int volume, int volumePan, unsigned __int16 playRate, char loopCount, unsigned __int8 playType)//270100
{
	...
	if (!soundAble_E3798
		|| !soundActive_E3799
		|| index - 1 > (signed int)MaxLoadedWavIndex_180B50
...
{
	if (soundAble_E3798 && soundActive_E3799 && index <= MaxLoadedWavIndex_180B50)
	{
		for (int i = 0; i < SoundBuffer3EndIdx_180B4C; i++)
		{
...
{
	if (pcSpeakerSoundDev_E3819 && musicAble_E37FC && musicActive_E37FD && songCurrentlyPlaying_E3802 && AilSequenceStatus_96170(m_hMusicSequence) != 2 && x_BYTE_E3817 != a1)
	{
		if (x_BYTE_E3818)
			;// sub_92DC0_AIL_release_timer_handle(x_DWORD_180C80);
		x_BYTE_E3817 = a1;
...
void PrepareEventSound_6E450(__int16 entityIndex, __int16 a2, __int16 soundIndex)//24f450
{
	...
	if (!soundActive_E3799 || !soundAble_E3798)
		return;
	if (Entities_EA3E4[entityIndex] <= Entities_EA3E4[0])
	{
		v10 = 0x7FFF;
		LOWORD(v12) = 0x7FFF;
	}
	...
	{
		if (Entities_EA3E4[entityIndex]->struct_byte_0xc_12_15.byte[0] < 0)
			return;
		v4x = &Entities_EA3E4[entityIndex]->axis_0x4C_76;
		if ((unsigned int)Maths::EuclideanDistXY_584D0(
			&Entities_EA3E4[D41A0_0.array_0x2BDE[D41A0_0.LevelIndex_0xc].playerIndex_0x00a_2BE4_11240]->axis_0x4C_76,
			&Entities_EA3E4[entityIndex]->axis_0x4C_76) > 0x9000000)
			return;
		v26x = Entities_EA3E4[D41A0_0.array_0x2BDE[D41A0_0.LevelIndex_0xc].playerIndex_0x00a_2BE4_11240];
		v29 = Entities_EA3E4[entityIndex]->id_0x1A_26;
		v5 = Maths::EuclideanDistXYZ_58490(&v26x->axis_0x4C_76, v4x);
		v25 = v5;
		v23 = v5;
