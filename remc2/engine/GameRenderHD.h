...
private:
	...
	void DrawSprites_3E360(int a2x, type_particle_str** str_DWORD_F66F0x[], uint8_t playersColors_E88E0x[], int32_t x_DWORD_F5730[], type_event_0x6E8E* ENTITY_EA3E4[], type_str_unk_1804B0ar str_unk_1804B0ar, ViewPort viewPort, uint16_t screenWidth);
	...
	uint16_t sub_3FD60(int a2x, uint8_t playersColors_E88E0x[], type_event_0x6E8E* ENTITY_EA3E4[], type_str_unk_1804B0ar str_unk_1804B0ar, type_particle_str** str_DWORD_F66F0x[], int32_t x_DWORD_F5730[], ViewPort viewPort, uint16_t screenWidth);
