			...
			if (!(v3x->struct_byte_0xc_12_15.byte[0] & 0x21))
			{
				...
				if (v7 > 64 && v8 < str_F2C20ar.dword0x15_tileRenderCutOffDistance)
				{
					...
					LABEL_70:
						...
						DrawSprite_41BD3(2u, str_F2C20ar.dword0x08_width);
						break;
					default:
						goto LABEL_70;
					}
		...
		if (!(v3x->struct_byte_0xc_12_15.byte[0] & 0x21))
		{
						...
						if (!v7x->byte_10)
						{
							...
							LABEL_73:
								...
								if (str_F2C20ar.dword0x09_realWidth > 0 && v46 > 0)
								{
									...
									DrawSprite_41BD3(0, str_F2C20ar.dword0x08_width);
								}
								break;
							default:
								goto LABEL_73;
			...
			if (v100 > 64 && v51 < str_F2C20ar.dword0x15_tileRenderCutOffDistance)
			{
				...
				LABEL_164:
					...
					str_F2C20ar.dword0x09_realWidth++;
					str_F2C20ar.dword0x0c_realHeight++;
					DrawSprite_41BD3(1u, str_F2C20ar.dword0x08_width);
					break;
				default:
					goto LABEL_164;
				}
...
void GameRenderHD::DrawSprite_41BD3(uint32 a1, const int32_t spriteWidth)
{
