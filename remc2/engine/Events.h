...
void CopyEventVar0408_49A20(type_entity_0x6E8E* event);
...
type_entity_0x6E8E* IfSubtypeCallAxisEvent_4A190(axis_3d* a1, int a2, int a3);
void sub_57E50(type_entity_0x6E8E* entity);
