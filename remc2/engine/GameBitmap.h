...
public:
	...
	static void PaletteToRgb(TColor* ptrPalette, uint8_t colorAddressIdx, uint8_t truColorOut[3]);
	static void PaletteToRgba(TColor* ptrPalette, uint8_t colorIdx, uint8_t truColorOut[4]);
	static uint8_t DeriveBlendAlpha(TColor* ptrPalette, uint8_t srcIndex, uint8_t dstIndex, uint8_t resultIndex);
};
